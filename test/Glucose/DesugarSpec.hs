  ...
  it "transforms a module with constants, aliases, enums & simple functions" $
    let input = "a=c\nb=3.21\nc=123\ntype it=This|that\nd=a\nid=\\a->a\ntest=\\a->id c"
        expected = Module
          ...
          , function ("id" `at` "6:1@39-6:2@40") ("a" `at` "6:5@43") (reference ("a" `at` "6:8@46"))
          , function ("test" `at` "7:1@48-7:4@51") ("a" `at` "7:7@54") (apply (reference $ "id" `at` "7:10@57-7:11@58") (reference $ "c" `at` "7:13@60")) ]
